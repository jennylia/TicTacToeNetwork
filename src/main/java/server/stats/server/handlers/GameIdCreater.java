...
import server.stats.server.data.GameSession;
...
public class GameIdCreater implements HttpHandler {
    ...
    private static final String GAME_SESSION_TABLE_NAME = "GameSession";
    private static DynamoDBMapper mapper = DynamoDBClient.getDynamoDBMapper();
    ...
    private boolean persistGameId2(String gameId) {
        Table table = dynamoDB.getTable(GAME_SESSION_TABLE_NAME);
        try {
